...
void pillar(pt P, float z, float r) { pt Q = P(P,V(0,0,z)); coneSection(P,Q,r,r); disk(Q,V(0,0,1),r);}

void hpillar(pt P, pt Q, float z, float r, float d) {
  vec V = U(V(P, Q));
  pt P1 = P(P, d, V(0,0,1));
  pt Q1 = P(P(Q, z/2., V), d, V(0,0,1));
  coneSection(P(P,d,V(0,0,1)),Q1,r,r); 
  disk(Q1, U(V(P,Q)), r);
  cone(P1, V(-z/2., V), r);
}
